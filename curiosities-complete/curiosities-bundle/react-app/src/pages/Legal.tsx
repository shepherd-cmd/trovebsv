        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <div className="parchment-card p-6 space-y-3 font-body text-card-foreground">
              <p>The following content may <strong>not</strong> be uploaded to curIosities under any circumstances:</p>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Every upload requires an explicit legal declaration. Uploading prohibited content may result in your account being suspended and the document being delisted from the curIosities index. It will not be removed from the BSV blockchain.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="parchment-card p-6 font-body text-card-foreground">
              <p className="leading-relaxed">
                curIosities is an <strong>indexing and display layer</strong> built on top of the BSV blockchain. When a document is inscribed, it is written to the blockchain by the user — curIosities does not control the blockchain and cannot delete content from it.
              </p>
              <p className="leading-relaxed mt-3">
                What curIosities <strong>can</strong> do is remove content from its index and stop displaying it in the application. A delisted document is no longer searchable, browsable, or monetised through curIosities, but the underlying blockchain record remains.
              </p>
              <p className="leading-relaxed mt-3">
          ...
          <section>
            ...
            <div className="parchment-card p-6 font-body text-card-foreground space-y-3">
              <p>
                curIosities operates under the safe harbour provisions of the <strong>UK Copyright, Designs and Patents Act 1988</strong> and the <strong>US Digital Millennium Copyright Act</strong>. If you believe content displayed on curIosities infringes your copyright, you may submit a takedown notice.
              </p>
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                ...
                <li>The URL or document ID of the allegedly infringing content on curIosities</li>
          ...
          <section>
            ...
            <div className="parchment-card p-6 font-body text-card-foreground">
              <p className="leading-relaxed">
                curIosities is committed to compliance with the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018. We collect only the data necessary to operate the platform. We do not sell personal data to third parties.
              </p>
              <p className="leading-relaxed mt-3">
                If you believe a document displayed on curIosities contains your personal data without your consent, please contact <strong>legal@curiosities.app</strong> with the subject line <em>GDPR Data Subject Request</em>. We will investigate and delist the content within 72 hours where warranted.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="parchment-card p-6 font-body text-card-foreground">
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                ...
                curIosities — registered in England and Wales
              </p>
            </div>
          </section>
