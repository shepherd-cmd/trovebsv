...
import { ENTRY_FEE_GBP, ENTRY_CREDITS } from "@/lib/metanet";
...
export const EntryPaywall = ({ onComplete }: EntryPaywallProps) => {
  ...
  const handlePurchase = async () => {
    ...
    try {
      // TODO: Integrate Stripe fiat gateway here.
      ...
      //   3. 50% of £3.99 → platform revenue (funds the app)
      //   4. 50% of £3.99 → converted to BSV sats at live rate, held for user's inscriptions
      // The user funds their own uploads — the platform treasury is never debited for inscriptions.
      ...
      toast.success(`Welcome to curIosities! Your BSV upload balance is ready.`);
      onComplete();
    } catch (error) {
